...
if lang == "tamil":
	without_mask_sound = "Sound_Effect\\without_mask\\tamil.mp3"

elif lang == "sinhala":
	without_mask_sound = "Sound_Effect\\without_mask\\sinhala.mp3"

elif lang == "english":
	without_mask_sound = "Sound_Effect\\without_mask\\english.mp3"
...
def without_mask_detected(frame):
	...
	ftp.storbinary('STOR '+"{}".format(file_name), open("cache_img.jpg", 'rb'))
...
def with_mask_detected():
	...
	if is_sound_playing == False:
		...
		if greeting == "morning":
			...
			if lang == "tamil":
				soundPlay("Sound_Effect\\with_mask\\tamil_morning.mp3")

			elif lang == "sinhala":
				soundPlay("Sound_Effect\\with_mask\\sinhala_morning.mp3")

			elif lang == "english":
				soundPlay("Sound_Effect\\with_mask\\english_morning.mp3")

		elif greeting == "afternoon":

			if lang == "tamil":
				soundPlay("Sound_Effect\\with_mask\\tamil_afternoon.mp3")

			elif lang == "sinhala":
				soundPlay("Sound_Effect\\with_mask\\sinhala_afternoon.mp3")

			elif lang == "english":
				soundPlay("Sound_Effect\\with_mask\\english_afternoon.mp3")

		elif greeting == "evening":

			if lang == "tamil":
				soundPlay("Sound_Effect\\with_mask\\tamil_evening.mp3")

			elif lang == "sinhala":
				soundPlay("Sound_Effect\\with_mask\\sinhala_evening.mp3")

			elif lang == "english":
				soundPlay("Sound_Effect\\with_mask\\english_evening.mp3")
